...
const NotFound: React.FC<NotFoundProps> = ({ homeLink = "/", buttonText = "Go Home" }) => {
  const handleGoHome = () => {
    window.location.href = homeLink;
  };

  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-[var(--bg-color)] text-[var(--text-color)] p-4" aria-label="404 Page Not Found">
      <div className="flex flex-col items-center text-center">
        <h1 className="text-5xl font-bold tracking-tighter sm:text-5xl animate-bounce">404</h1>
