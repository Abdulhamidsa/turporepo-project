...
import { useUserProfile, defaultUserProfile } from "../hooks/use.user.profile";
import { useUserProjects } from "../hooks/use.user.profile";
import { ProfileType } from "@repo/data/types/user";
import ProjectCard from "../../projects/components/ProjectCard";
import ProjectModal from "../../projects/components/ProjectModal";
import { useState } from "react";
import ProfilePictureEdit from "../components/ProfilePicture";
import { Countries } from "@repo/data/constants/countries";

const getCountryFlagIcon = (countryName: string | undefined): string => {
...
export default function ProfilePage() {
  ...
  // Merge the user profile with defaults
  const user: ProfileType = { ...defaultUserProfile, ...(userProfile || {}) };
    ...
    <PageTransition>
      <div className="min-h-screen bg-background">
        ...
        <div className="relative h-64 md:h-80 overflow-hidden">
          <img src={user.coverImage || "/default-cover.jpg"} alt="Cover" className="object-cover w-full h-full" />
            ...
            <div className="flex flex-col md:flex-row items-center md:items-start md:space-x-8">
              ...
              <div className="flex-1 mt-6 md:mt-0">
                <div className="text-center md:text-left">
                  ...
                  <p className="text-lg md:text-xl text-muted-foreground">@{loggedUser?.friendlyId}</p>
                </div>
