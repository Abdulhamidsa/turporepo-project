...
export default function Auth() {
  ...
  // const openSignIn = (prefillValues?: { email?: string }) => {
  //   setIsSignIn({ mode: "signin", prefillValues });
  // };
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-muted to-background text-foreground">
      ...
      <div className="relative flex flex-col items-center justify-center h-screen bg-gradient-to-t from-background to-muted px-4 text-center">
        ...
        <h1 className="text-6xl font-bold text-foreground max-w-4xl relative z-10">
          Build, Showcase, and Connect with <span className="text-primary">Professionals</span>
        </h1>
        <p className="mt-4 text-lg text-muted-foreground max-w-2xl relative z-10">Welcome to your ultimate portfolio builder. Create your professional presence, showcase your skills, and connect with a vibrant community.</p>
      ...
      <section className="py-20 bg-muted">
        <div className="container mx-auto max-w-6xl px-6 text-center">
          ...
          <p className="mt-2 text-muted-foreground text-lg">Tools, community, and design to elevate your professional journey.</p>
          <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {[Briefcase, Users, Palette, Rocket, Zap, Globe].map((Icon, index) => (
              <div key={index} className="flex flex-col items-center bg-card p-6 rounded-lg shadow-lg">
                ...
                <h3 className="mt-4 text-xl font-bold text-foreground">{["Beautiful Portfolios", "Engaging Community", "Customizable Templates", "Built for Professionals", "Easy to Use", "Share Your Work"][index]}</h3>
